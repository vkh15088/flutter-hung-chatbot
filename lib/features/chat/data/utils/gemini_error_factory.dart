...
class GeminiErrorFactory {
  ...
  static GeminiError createCacheError() => GeminiError(
        error: const ErrorEntity(
          code: 0,
          message: 'Failed to save message to cache',
          status: 'Cache Error',
          details: [],
        ),
      );
  ...
  static GeminiError createServerError() => GeminiError(
        error: const ErrorEntity(
          code: 500,
  ...
  static GeminiError createUnexpectedDataError(String message) => GeminiError(
        error: ErrorEntity(
          code: 0,
          message: message,
          status: 'Unexpected Data Error',
          details: const [],
        ),
      );
